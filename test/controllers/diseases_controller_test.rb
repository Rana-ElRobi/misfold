...
class DiseasesControllerTest < ActionController::TestCase
  ...
  test "should create disease" do
    assert_difference('Disease.count') do
      post :create, disease: { clinicalpicture: @disease.clinicalpicture, diseaseid: @disease.diseaseid, diseasename: @disease.diseasename, icd10id: @disease.icd10id, pathogenesis: @disease.pathogenesis }
    end
  ...
  test "should update disease" do
    patch :update, id: @disease, disease: { clinicalpicture: @disease.clinicalpicture, diseaseid: @disease.diseaseid, diseasename: @disease.diseasename, icd10id: @disease.icd10id, pathogenesis: @disease.pathogenesis }
    assert_redirected_to disease_path(assigns(:disease))
  end
