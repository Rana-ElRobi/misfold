...
class ProteinsControllerTest < ActionController::TestCase
  ...
  test "should create protein" do
    assert_difference('Protein.count') do
      post :create, protein: { length: @protein.length, name: @protein.name, sequence: @protein.sequence, uniprot_id: @protein.uniprot_id }
    end
  ...
  test "should update protein" do
    patch :update, id: @protein, protein: { length: @protein.length, name: @protein.name, sequence: @protein.sequence, uniprot_id: @protein.uniprot_id }
    assert_redirected_to protein_path(assigns(:protein))
  end
