...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { id: @relationship.id, name: @relationship.name, neighbors: @relationship.neighbors, type: @relationship.type }
    end
  ...
  test "should update relationship" do
    patch :update, id: @relationship, relationship: { id: @relationship.id, name: @relationship.name, neighbors: @relationship.neighbors, type: @relationship.type }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
